...
class LoginScreen extends StatefulWidget {
  ...
  @override
  State<LoginScreen> createState() => _AddVayNowState();
}

class _AddVayNowState extends State<LoginScreen> {
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SearchWidget(
                                searchController: _phoneController,
                              ...
                              GestureDetector(
                                onTap: () {
                                  ...
                                  BlocProvider.of<HomeBloc>(context).add(LoginEvent(
                                      ...
                                      func: (message, status) {
                                        if (status) {
                                          CommonFlushBar.show(context, message, EFlushbarStatus.Success);
                                ...
                                child: Container(
                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                        ...
                                        children: [TextSpan(text: 'đăng ký ngay.', style: Styles.n12v7.copyWith(color: context.colors.text))]),
                                  ),
                                ),
                              ),
                              spaceH4,
